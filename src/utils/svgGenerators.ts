 ...
 * Generates SVG poster graphics for the preseeded SAMPLE campaigns only.
 * Real campaigns use images generated by TokenRouter (seedream) and served from
 * Backblaze B2 — nothing in the live pipeline calls this.
 * Kept so the Library still has content when the B2 bucket is empty.
